...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { address: @passenger.address, card_num: @passenger.card_num, email: @passenger.email, name: @passenger.name, password: @passenger.password, phone_num: @passenger.phone_num, username: @passenger.username } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { address: @passenger.address, card_num: @passenger.card_num, email: @passenger.email, name: @passenger.name, password: @passenger.password, phone_num: @passenger.phone_num, username: @passenger.username } }
